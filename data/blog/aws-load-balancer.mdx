...
tags: ['AWS', 'SSA']
draft: false
summary: 'AWS Elastic Load Balancing (ELB) là dịch vụ cân bằng tải, giúp tự động phân phối lưu lượng truy cập đến nhiều tài nguyên như EC2, ECS, EKS hoặc Lambda nhằm tăng tính sẵn sàng, khả năng mở rộng và khả năng chịu lỗi của ứng dụng'
authors: ['Quan Bui']
---

import { AUTHORS } from '../authors/constants'
